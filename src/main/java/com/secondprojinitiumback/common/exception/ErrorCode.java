...
public enum ErrorCode {
    ...
    PASSWORD_MISSING_NUMBER(HttpStatus.BAD_REQUEST, "비밀번호에 숫자가 포함되어야 합니다."),
    PASSWORD_MISSING_UPPERCASE(HttpStatus.BAD_REQUEST, "비밀번호에 대문자가 포함되어야 합니다."),
    PASSWORD_MISSING_SPECIAL(HttpStatus.BAD_REQUEST, "비밀번호에 특수문자가 포함되어야 합니다."),
    PASSWORD_RECENTLY_USED(HttpStatus.BAD_REQUEST, "최근에 사용한 비밀번호는 재사용할 수 없습니다."),
    PASSWORD_SAME_AS_CURRENT(HttpStatus.BAD_REQUEST, "현재 비밀번호와 동일한 비밀번호는 사용할 수 없습니다."),
