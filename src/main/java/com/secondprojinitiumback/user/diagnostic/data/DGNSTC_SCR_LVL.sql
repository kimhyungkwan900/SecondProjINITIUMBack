...
VALUES
-- 1단계: 섭식 문제 없음
(3, 0, 16, '섭식 문제 없음', '현재 식사나 음식 섭취, 체중, 다이어트 등에 관련된 심각한 문제는 보이지 않습니다.'),

-- 2단계: 섭식 문제의 경향성 있음
(3, 17, 36, '섭식 문제의 경향성 있음', '음식 섭취, 체중, 다이어트 등과 관련하여 주관적인 문제를 경험할 가능성이 있습니다. 일상생활에서 불편함이 크지 않으나 스트레스 상황에서 증상이 나타날 수 있습니다.'),

-- 3단계: 섭식 문제 있음
(3, 37, 54, '섭식 문제 있음', '음식 섭취, 체중, 다이어트 등에 관련하여 문제의식을 가지고 있으며 실제 행동 및 신체적인 문제를 경험하고 있을 가능성이 높습니다. '),

-- 4단계: 심각한 섭식 문제 있음
(3, 55, 100, '심각한 섭식 문제 있음', '심각한 식사와 체중 조절 문제로 인해 건강에 큰 영향을 미칠 가능성이 높습니다. 즉시 전문적인 상담과 치료 개입이 필요합니다.');
