...
-- 2단계: 약한 정도의 증상
(2, 64, 81, '약한 정도의 증상', '경미한 수준의 사회불안이 있습니다. 이러한 점수는 건강한 사람이라면 누구나 느끼게 되는 불안의 수준이라고 할 수 있습니다. 평가나 상황에 대해 중요하게 생각하고 계시며, 불안이 되더라도 큰 문제는 없으며, 이러한 불안을 관리하며 사회생활을 유지할 수 있습니다.'),

-- 3단계: 중간 정도의 증상
(2, 82, 98, '중간 정도의 증상', '중간 정도의 사회불안을 겪고 계시지만 사회공포증 수준까지는 아닙니다. 이는 개인의 상태에 따라 큰 불편감을 경험할 수도 있고, 불편하기는 하지만 일상생활을 하는 데는 큰 지장이 없습니다. 그러나 본인이 불편함을 느낀다면 집단치료나 개별 상담을 통해서 도움을 받을 수 있습니다.'),

-- 4단계: 심한 정도의 증상
(2, 99, 140, '심한 정도의 증상', '즉시 초기면접을 받아보시길 권해드립니다. 이 점수는 사회공포증일 가능성이 매우 큽니다. 현재 전반적인 사회활동이나 특정한 상황(ex. 발표 상황)에서 불안을 느끼고 계시며, 장기간 지속될 수 있습니다. 사회공포증은 치료하지 않으면 오랜 기간 지속되므로 초기면접 및 적절한 치료를 받으시는 것을 강력히 권장합니다.');
...
-- 2단계: 섭식 문제의 경향성 있음
(3, 15, 18, '섭식 문제의 경향성 있음', '음식 섭취, 체중, 다이어트 등과 관련하여 주관적인 문제를 경험할 가능성이 있습니다. 일상생활에서 불편함이 크지 않으나 스트레스 상황에서 증상이 나타날 수 있습니다. 상담센터 방문을 권유드립니다.'),
(3, 18, 21, '섭식 문제의 경향성 있음', '음식 섭취, 체중, 다이어트 등과 관련하여 주관적인 문제를 경험할 가능성이 있습니다. 일상생활에서 불편함이 크지 않으나 스트레스 상황에서 증상이 나타날 수 있습니다. 상담센터 방문을 권유드립니다.'),

-- 3단계: 섭식 문제 있음
(3, 19, 22, '섭식 문제 있음', '음식 섭취, 체중, 다이어트 등에 관련하여 문제의식을 가지고 있으며 실제 행동 및 신체적인 문제를 경험하고 있을 가능성이 높습니다. 생활 개선이 필요하며 상담센터의 평가를 권장합니다.'),
(3, 22, 27, '섭식 문제 있음', '음식 섭취, 체중, 다이어트 등에 관련하여 문제의식을 가지고 있으며 실제 행동 및 신체적인 문제를 경험하고 있을 가능성이 높습니다. 생활 개선이 필요하며 상담센터의 평가를 권장합니다.'),
