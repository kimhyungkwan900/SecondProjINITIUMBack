-- 강박증 자가진단검사
INSERT INTO DGNSTC_TST (DGNSTC_TST_NM, DGNSTC_TST_DC, DEL_YN)
VALUES ('강박증 자가진단검사', '강박증 증상 정도를 평가하는 자가진단 검사', 'N');

-- 사회공포·회피 검사 (대학생 버전 기준)
INSERT INTO DGNSTC_TST (DGNSTC_TST_NM, DGNSTC_TST_DC, DEL_YN)
VALUES ('사회공포·회피 진단검사', '대인관계 상황에서의 불안 및 회피 수준을 측정하는 검사', 'N');
